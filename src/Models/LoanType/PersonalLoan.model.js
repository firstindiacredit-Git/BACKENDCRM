...
const personalLoanSchema = new mongoose.Schema(
  {
    ...
    loanId: {
      ...
      default: function () {
        ...
        return `PL-${uuid.slice(0, 8)}`; // Changed CAR to PL for Personal Loan
      },
    },
    ...
    officeCityState: { type: String, required: true },
...
const PersonalLoan =
  mongoose.models.PersonalLoan ||
  mongoose.model("PersonalLoan", personalLoanSchema);
